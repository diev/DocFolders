...
namespace DocFolders.Migrations
{
    ...
    [Migration("20160417221206_Migration2")]
    partial class Migration2
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("DocFolders.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DocFolders.Models.Link", b =>
                {
                    ...
                    b.HasKey("OuterId", "InnerId");

                    b.HasAnnotation("Relational:TableName", "Links");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DocFolders.Models.ApplicationUser")
                        .WithMany()
